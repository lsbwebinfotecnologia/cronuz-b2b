    ...
    const renderBlock = (block: any, index: number) => {
        switch(block.type) {
            ...
            case 'CAROUSEL':
                ...
                return (
                    <div id={block.id} key={block.id} className="py-24 bg-zinc-950 border-y border-white/5 relative overflow-hidden" style={block.backgroundColor ? { backgroundColor: block.backgroundColor } : undefined}>
            ...
            case 'HTML':
                return (
                    <div id={block.id} key={block.id} className="py-12 bg-white text-slate-900" style={block.backgroundColor ? { backgroundColor: block.backgroundColor } : undefined}>
                        <div className="max-w-7xl mx-auto px-6 ql-editor" dangerouslySetInnerHTML={{ __html: block.content || '' }} />
                    </div>
                );
