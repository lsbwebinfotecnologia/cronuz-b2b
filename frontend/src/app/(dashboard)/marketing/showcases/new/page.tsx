  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-slate-900 dark:text-white">Criar Nova Vitrine</h1>
          <p className="text-sm text-slate-500 dark:text-slate-400">Configure as regras de exibição e os banners visuais para a Storefront.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-end gap-3 pt-6">
          ...
          >
             {isSubmitting ? 'Gerando Vitrine...' : <><Save className="w-5 h-5" /> Salvar Vitrine</>}
          </button>
        </div>
      </form>
    </div>
