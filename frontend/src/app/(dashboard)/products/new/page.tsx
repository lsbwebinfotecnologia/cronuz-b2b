            ...
            {activeTab === 'images' && (
             ...
             >
                <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 dark:bg-slate-900/50 dark:border-slate-800 text-center py-20">
                   ...
                   <p className="text-slate-500 text-sm mb-6 max-w-sm mx-auto dark:text-slate-400">Em breve você poderá arrastar imagens diretamente para nossa CDN Cronuz.</p>
                   <button disabled className="bg-slate-100 text-slate-500 px-6 py-2.5 rounded-xl font-medium cursor-not-allowed dark:bg-slate-800 dark:text-slate-400 border border-slate-200 dark:border-slate-700">Explorar CDN (Integração Futura)</button>
                </div>
             </motion.div>
            )}
